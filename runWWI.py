...
ATTRIBUTE_NAME = ['num_CL1', 'S_d1', 'S_s1', 'mean', 'lower', 'upper']
SERVICE_DEVICE_CL1 = np.arange(0.02,0.08,0.001)
...
count = 0
total = len(SERVICE_DEVICE_CL1) * len(SERVICE_SERVER_CL1)
for r_d1 in rate_device_cl1:
	for r_s1 in rate_server_cl1:
		count += 1
		params = [NUM_CUSTOMERS_CL1, r_d1, r_s1]
